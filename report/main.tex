...
\newcommand{\LateWindowRate}{74.5\%}
\newcommand{\EarlyReturn}{$-$26}
\newcommand{\LateReturn}{$+$95}
...
navigation environment (\emph{ChopperScape}) with per-episode layout
...
\begin{figure}[H]
  ...
  \caption{The \emph{ChopperScape} environment (one sampled layout). The rover
...
($\sim$$20\%$ of them), and the arrival rate climbs steadily as the noise
...
\texttt{ChopperScape.render()}, every figure in this report, and an animated
